...
class RevokeRequestPayload(Struct):
    ...
    should activate. See Section 4.20 of the KMIP 1.1 specification for more
    information.
    ...
    def __init__(self,
        ...
        Args:
            ...
            revocation_reason (Enum): The reason why the object was revoked.
            compromise_date (date): the date of compromise if the object was
                compromised.
        """
    ...
    def read(self, istream):
        ...
        self.revocation_reason = enums.RevocationReason()
        self.revocation_reason.read(tstream)

        # TODO(tim-kelsey): handle the date properly
        # self.compromise_date =
        # self.compromise_date.read(stream)
